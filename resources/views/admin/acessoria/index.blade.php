...
@section('content')    
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li> <a href="#" class="active"><a href="#">Acessorias</a></li>
        </ol>
        ...
        <div class="row">
            @if (auth()->user()->isAdmin())
                ...
                <div class="col-lg-2">
                    <a href="{{route('acessoria-create')}}" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Adicionar Acessoria</a>
                    <p>
                </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-inline" method="GET" action="{{route('acessorias')}}">                           
